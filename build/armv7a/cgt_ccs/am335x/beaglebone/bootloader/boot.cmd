...
MEMORY
{
        IRAM_MEM        : org = 0x402F0400  len = 0xFC00            //PUBLIC RAM   64 К/байт
        L3_SRAM         : org = 0x40300000  len = 0x10000            //PUBLIC RAM   64 К/байт
}
...
SECTIONS
{
    ...
    .stack   : load > 0x402FFFF0            // SOFTWARE SYSTEM STACK  загоняем стек в самы конец
}
*/
...
MEMORY
{
        IRAM_MEM        : org = 0x40300000  len = 0x10000            //PUBLIC RAM   64 К/байт
}
...
SECTIONS
{
    ...
    .sysmem  : load > IRAM_MEM                                         // GLOBAL & STATIC VARIABLES.
                    ...
                    RUN_END(bss_end)
    .const   : load > IRAM_MEM              // GLOBAL CONSTANTS
    .stack   : load > 0x4030FFF0            // SOFTWARE SYSTEM STACK  загоняем стек в самы конец
}
*/
MEMORY
{
        IRAM_MEM        : org = 0x402F0400  len = 0x1FBFF            //PUBLIC RAM
}
